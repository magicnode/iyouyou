...
class mail_msgModule extends AuthModule
{		
	...
	{				
		...
		$GLOBALS['tmpl']->assign("formaction",admin_url("mail_msg"));
		$GLOBALS['tmpl']->assign("delurl",admin_url("mail_msg#foreverdelete",array('ajax'=>1)));		
		$GLOBALS['tmpl']->assign("editurl",admin_url("mail_msg#edit"));
		$GLOBALS['tmpl']->assign("addurl",admin_url("mail_msg#add"));
		$GLOBALS['tmpl']->display("core/mail_msg/index.html");
	}	
	...
	{		
		...
		$GLOBALS['tmpl']->assign("formaction",admin_url("mail_msg#insert",array("ajax"=>1)));
		$GLOBALS['tmpl']->display("core/mail_msg/add.html");
	}
	...
	public function insert() {
		...
		if ($GLOBALS['db']->error()=="") {
			...
			showSuccess(lang("INSERT_SUCCESS"),$ajax,admin_url("mail_msg#add"));
		} else {
			//错误提示
	...
	public function edit() {		
		...
		$GLOBALS['tmpl']->assign("formaction",admin_url("mail_msg#update",array("ajax"=>1)));
		$GLOBALS['tmpl']->display("core/mail_msg/edit.html");
	}
