<link rel="stylesheet" href="<?php echo $this->_var['TMPL']; ?>/css/waterfall_user_active.css">
...
<div class="waterfall_main">
    ...
    <input type="hidden" class="view_guide_ajax_url" value="<?php echo $this->_var['view_guide_ajax_url']; ?>"/>
</div>
...
<script>
    ...
    $(function(){
        ...
        var insert_param = "<?php echo $this->_var['insert_param']; ?>";//瀑布流参数
        //分页毁掉函数
