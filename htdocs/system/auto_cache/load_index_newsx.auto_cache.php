<?php
//加载首页新闻模块
class load_index_newsx_auto_cache extends auto_cache{
	public function load($param)
	{
		...
		if($index_news === false)
		{
			$index_news = $GLOBALS['db']->getAll("select `name`,`id` from ".DB_PREFIX."news_cate where is_index = 1 order by sort desc limit 6");
