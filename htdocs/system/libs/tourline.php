...

{
	...
	if($rec_type==1||$rec_type==2||$rec_type==3||$rec_type==4||$rec_type==5) //国内游，出境游
...
function get_tourline($id=0){
...

	{
		...
		$tourline['tour_desc'] = format_html_content_image($tourline['tour_desc']);

		$tourline['appoint_desc'] = format_html_content_image($tourline['appoint_desc']);
